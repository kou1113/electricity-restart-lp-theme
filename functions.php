...
function electricity_restart_area_data( $slug ) {
	$areas = array(
		...
		'chubu' => array(
			...
			'areas' => array( '愛知県', '長野県', '静岡県の富士川以西', '岐阜県（飛騨市、郡上市、関ケ原町を除く）', '三重県（熊野市の飛鳥町、有馬町、育生町、五郷町、井戸町、金山町、神川町、木本町、紀和町、久生屋町以南の地区を除く）' ), 'faq' => '中部電力エリアは、長野県、愛知県、岐阜県（飛騨市、郡上市、関ケ原町を除く）、三重県（熊野市の飛鳥町、有馬町、育生町、五郷町、井戸町、金山町、神川町、木本町、紀和町、久生屋町以南の地区を除く）、静岡県の富士川以西になります。',
