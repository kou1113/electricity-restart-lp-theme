  ...
  <main id="top">
    ...
    <section class="area-summary" aria-labelledby="area-summary-title">
      <div class="container area-summary-inner">
        ...
        <ul><?php foreach ( $electricity_restart_area['areas'] as $supported_area ) : ?><?php $area_length = function_exists( 'mb_strlen' ) ? mb_strlen( $supported_area ) : strlen( $supported_area ); ?><li class="<?php echo esc_attr( $area_length >= 30 ? 'is-wide' : ( $area_length >= 16 ? 'is-medium' : '' ) ); ?>"><span><?php echo esc_html( $supported_area ); ?></span></li><?php endforeach; ?></ul>
      </div>
    </section>
